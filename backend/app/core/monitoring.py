...
class EndpointMonitor:
    ...
    def get_endpoint_stats(self, endpoint: str, method: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "p95_response_time": (
                times_sorted[int(len(times_sorted) * 0.95)] if times_sorted else 0.0
            ),
            "p99_response_time": (
                times_sorted[int(len(times_sorted) * 0.99)] if times_sorted else 0.0
            ),
    ...
    def get_system_health(self) -> Dict[str, Any]:
        ...
        return {
            "status": (
                "healthy" if cpu_percent < 90 and memory.percent < 90 else "degraded"
            ),
