...
export default function CoverLettersError({
  ...
  useEffect(() => {
    captureException(error, { digest: error.digest, page: 'dashboard/cover-letters' });
      ...
      <div className="w-full max-w-md space-y-6 text-center">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            We couldn&apos;t load your cover letters. Please try again.
          </p>
          {error.digest && (
        ...
        <div className="flex flex-col gap-3">
          ...
          <Button variant="outline" asChild className="w-full">
            <Link href="/dashboard/cover-letters">
              <FileText className="mr-2 h-4 w-4" /> View Cover Letters
            </Link>
          </Button>
        </div>
      </div>
