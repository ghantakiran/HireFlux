          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-6">
            {[1, 2, 3, 4].map((i) => (
              <div
                ...
                className="bg-white dark:bg-gray-900 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 animate-pulse"
              >
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex items-center justify-center p-6">
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8 max-w-md text-center">
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Empty State */}
        {hasNoJobs && (
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-12 text-center mb-8">
            <Briefcase className="w-16 h-16 text-gray-400 mx-auto mb-4" />
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">No Active Jobs</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-6">Get started by posting your first job</p>
            <Button onClick={onPostJob} size="lg">
              <Plus className="w-5 h-5 mr-2" />
              Post Your First Job
            </Button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          >
            ...
            <p className="text-3xl font-bold text-gray-900 dark:text-gray-100">{data.stats.activeJobs}</p>
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">Currently hiring</p>
          </div>
          ...
          >
            <div className="flex items-center justify-between mb-2">
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">New Applications Today</p>
              <Users className="w-5 h-5 text-green-600" />
            </div>
            <p className="text-3xl font-bold text-gray-900 dark:text-gray-100">{data.stats.newApplicationsToday}</p>
          ...
          >
            <div className="flex items-center justify-between mb-2">
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Candidate Quality</p>
              <TrendingUp className="w-5 h-5 text-purple-600" />
            </div>
            <p className="text-3xl font-bold text-gray-900 dark:text-gray-100">{data.stats.avgCandidateQuality}</p>
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">Average Fit Index</p>
          </div>
          ...
          >
            <div className="flex items-center justify-between mb-2">
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Time to Fill</p>
              <Clock className="w-5 h-5 text-orange-600" />
            </div>
            <p className="text-3xl font-bold text-gray-900 dark:text-gray-100">{data.stats.avgTimeToFill} days</p>
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">Average duration</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div data-testid="applications-by-status" className="bg-white dark:bg-gray-900 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4">Applications by Status</h2>
          ...
          <div className="space-y-4">
            {data.recentActivity.length === 0 ? (
              ...
              data.recentActivity.map((activity) => (
                <div
                  key={activity.id}
                  className="flex items-start gap-4 border-b border-gray-100 dark:border-gray-800 last:border-0 pb-4 last:pb-0"
                >
