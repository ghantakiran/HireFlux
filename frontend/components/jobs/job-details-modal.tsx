  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent
        ...
        className="fixed inset-0 z-50 w-full h-full max-w-none m-0 p-0 rounded-none bg-white overflow-y-auto"
        style={{
      ...
      >
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 data-job-title className="text-2xl font-bold text-gray-900 mb-1">
                {job.title}
              </h2>
              <p data-company-name className="text-lg text-gray-700">
                {job.company}
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {job.salary && (
              <div className="flex items-center gap-2 text-gray-900 font-semibold col-span-2">
          ...
          <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
            <p className="text-sm font-medium text-green-900 mb-1">Fit Score</p>
            <p className="text-3xl font-bold text-green-600">{job.fitIndex}% Match</p>
          ...
          <div>
            ...
            <p data-job-description className="text-gray-700 leading-relaxed">
              {job.description}
            </p>
          </div>
