...
export function getCategoryColor(category: TemplateCategory): string {
  const colors: Record<TemplateCategory, string> = {
    [TemplateCategory.ENGINEERING]: 'bg-blue-100 text-blue-800',
    [TemplateCategory.PRODUCT]: 'bg-purple-100 text-purple-800',
    [TemplateCategory.DESIGN]: 'bg-pink-100 text-pink-800',
    [TemplateCategory.SALES]: 'bg-green-100 text-green-800',
    [TemplateCategory.MARKETING]: 'bg-yellow-100 text-yellow-800',
    [TemplateCategory.OPERATIONS]: 'bg-orange-100 text-orange-800',
    [TemplateCategory.CUSTOMER_SUCCESS]: 'bg-teal-100 text-teal-800',
    [TemplateCategory.HR]: 'bg-indigo-100 text-indigo-800',
    [TemplateCategory.FINANCE]: 'bg-red-100 text-red-800',
    [TemplateCategory.DATA]: 'bg-cyan-100 text-cyan-800',
    [TemplateCategory.OTHER]: 'bg-gray-100 text-gray-800',
  };
